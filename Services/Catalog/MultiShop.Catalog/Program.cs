...
//appsettingjsond da tanýmladýðýmýz DatabaseSettings'i configure ediyoruz.
builder.Services.Configure<DatabaseSettings>(builder.Configuration.GetSection("DatabaseSettings"));

//database settings sýnýfýndaki value'lara ulaþmak için. (db name , table,baðlantýlar)
