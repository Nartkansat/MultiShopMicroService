...
namespace MultiShop.Catalog.Services.FeatureSliderServices
{
    public class FeatureSliderService : IFeatureSliderService
    {
        ...
        {
            var values = await _featureSliderCollection.Find(x => true).ToListAsync(); //tüm hepsini çağır
            return _mapper.Map<List<ResultFeatureSliderDto>>(values);    //maple ve list ile dönder
        }
