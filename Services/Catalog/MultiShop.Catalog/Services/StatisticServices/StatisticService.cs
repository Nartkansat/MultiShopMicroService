...
namespace MultiShop.Catalog.Services.StatisticServices
{
    public class StatisticService : IStatisticService
    {
        ...
        {
            //mongo db'de kullanılan gruplayarak avg alma işlevi
            ...
            var result = await _productCollection.AggregateAsync<BsonDocument>(pipeline); //aggregate fonksiyonlar; count,min,max,avg,sum
